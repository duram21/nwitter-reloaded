...
export default function Project(){
  ...
  return <Wrapper>
    ...
    <button class="make" value="경작서 만들어보기" id="run" onclick="start_program();">경작서 만들어보기</button><button class="makeDay" value="안된 주간 돌리기" id="makeDay" onclick="dayWork();">안된 주간 돌리기</button>
